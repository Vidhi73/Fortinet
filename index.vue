  ...
  <div>
    <div class="shadow">
        <nav class="navbar navbar-light navbar-expand-md navigation-clean bg-white">
            <div class="container justify-content-center"><a class="navbar-brand" href="#" style="font-family: Muli, sans-serif;font-weight: bold;">Fortinet Resturant Directory</a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <!-- <div
